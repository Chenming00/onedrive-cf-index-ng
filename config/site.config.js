...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'me@cmand.us',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/chenming00',
    },
  ],
